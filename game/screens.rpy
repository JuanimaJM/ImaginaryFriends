...
screen main_menu():
    ...
    add timely_bg_main_menu_image()
    add timely_bg_main_menu_animated()
    add leaf_particles1
    add leaf_particles2
    add leaf_particles3
...
style game_menu_outer_frame:
    bottom_padding 45
    top_padding 180
    # background "gui/frame_backgrounds/menu_overlay.png"
...
style confirm_frame:
    background Frame([ "gui/confirm_frame.png", paper_frame], gui.confirm_frame_borders, tile=gui.frame_tile)
